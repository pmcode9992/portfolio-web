...
const Floor = () => {
  const floorTexture = useTexture("assets/textures/wall.jpg");
...
const App  = () => {
  const { scene } = useGLTF("assets/models/StandingDesk.glb");
  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      ...
      >
        ...
        <mesh
          ref={monitorRef}
          position={[0.25, 1.5, 6.35]} // Adjust this position based on the actual monitor location
          scale={[0.4, 0.4, 0.1]} // Increase scale to make it large and visible
